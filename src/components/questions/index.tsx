      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-start justify-between max-w-7xl mx-auto gap-16">
          <div className="lg:w-5/12 lg:sticky lg:top-20">
            <h2 className="text-4xl md:text-5xl font-bold text-[#B42A76] mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-2xl border border-[#B42A76]/10 shadow-sm">
                <Shield className="w-8 h-8 text-[#B42A76] mb-4" />
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#B42A76]/10 shadow-sm">
                <MessageCircle className="w-8 h-8 text-[#B42A76] mb-4" />
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#B42A76]/10 shadow-sm">
                <Clock className="w-8 h-8 text-[#B42A76] mb-4" />
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#B42A76]/10 shadow-sm">
                <CreditCard className="w-8 h-8 text-[#B42A76] mb-4" />
            ...
            <div className="mt-12 bg-gradient-to-r from-[#B42A76]/5 to-[#FFF2F8] p-6 rounded-2xl">
              <p className="text-[#6D243F] font-medium mb-3">Ainda tem dúvidas?</p>
              <button className="text-[#B42A76] font-medium hover:text-[#6D243F] transition-colors hover:cursor-pointer">
            ...
            <Accordion.Root type="single" collapsible className="space-y-3">
              {questions.map((item, index) => (
                <Accordion.Item
                  key={index}
                  value={`item-${index}`}
                  className="bg-white rounded-xl border border-[#B42A76]/10 shadow-sm overflow-hidden"
                >
                  <Accordion.Header>
                    <Accordion.Trigger className="flex w-full items-center justify-between px-6 py-4 text-left hover:bg-[#FFF2F8] transition-colors">
                      ...
                      <ChevronDownIcon className="h-5 w-5 text-[#B42A76] transition-transform duration-300 group-data-[state=open]:rotate-180" />
                    </Accordion.Trigger>
                  </Accordion.Header>
                  <Accordion.Content className="overflow-hidden">
                    <div className="px-6 py-4 text-gray-600 border-t border-[#B42A76]/5">
                      {item.answer}
                    </div>
                  </Accordion.Content>
                </Accordion.Item>
